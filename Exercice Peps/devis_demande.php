    ...
    <div class="container">
        ...
        <form id="devis-form">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="company" name="company" aria-describedby="company-help" placeholder="Entreprise">
                <div id="company-help" class="form-text">Facultatif</div>
            </div>
            <div class="mb-3">
                <label for="phone" class="form-label">Numéro de téléphone *</label>
                <input type="tel" class="form-control" id="phone" name="phone" required pattern="(0|\+33)[1-9][0-9]{8}" placeholder="0601020304 ou +33601020304">
            </div>
            <div class="mb-3">
            ...
            <h2> Votre projet </h2>
            <div class="mb-3">
                <label class="form-label">Votre besoin *</label><br>
            ...
            <div class="mb-3">
                <label for="budget" class="form-label">Budget (en €) *</label>
                <input type="number" class="form-control" id="budget" name="budget"  required placeholder="Ex : 1000">
            </div>
            <div class="mb-3">
